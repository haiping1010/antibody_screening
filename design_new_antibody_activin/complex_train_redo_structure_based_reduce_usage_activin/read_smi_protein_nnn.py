...
class TestbedDataset(InMemoryDataset):
    ...
    def process(self, xd, pocket1_graph, y, pocket2_graph):
        ...
        for i in range(data_len):
            ...
            c_size1, features1, edge_index1 =  pdb_graph('all_data/'+arr_f[1].replace('.pdb','_poc.pdb'))
...
train_data = TestbedDataset(root='data1', dataset='L_P_train', xd=arr_name, pocket1_graph=pocket1_graph, y=train_Y, pocket2_graph=pocket2_graph)
