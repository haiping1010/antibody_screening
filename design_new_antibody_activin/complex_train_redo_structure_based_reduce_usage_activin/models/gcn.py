...
class GCNNet(torch.nn.Module):
    ...
    def __init__(self, n_output=1, n_filters=64, embed_dim=1280,num_features_xd=60,edge_dim_xd=10, output_dim=1280, dropout=0.2):
        ...
        self.conv2 = TransformerConv(num_features_xd*5, num_features_xd,heads=5, concat=True, dropout=0.1,edge_dim=edge_dim_xd)
        ...
        self.fc_g1 = torch.nn.Linear(num_features_xd*5, 1024)
