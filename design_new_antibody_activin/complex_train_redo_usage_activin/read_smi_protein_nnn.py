...
class TestbedDataset(InMemoryDataset):
    ...
    def process(self, xd, pocket1_graph, y, pocket2_graph):
        ...
        for i in range(data_len):
            ...
            #fr=open(arr_f[0],'r')
            #print (linearr[0])
            c_size, features, edge_index =  pdb_graph('all_data/'+filename.replace('.pdb','_antigen_poc.pdb'))
            ...
            c_size1, features1, edge_index1 =  pdb_graph('all_data/'+filename.replace('.pdb','_antibody_poc.pdb'))
...
train_data = TestbedDataset(root='data1', dataset='L_P_train_'+input_f, xd=arr_name, pocket1_graph=pocket1_graph, y=train_Y, pocket2_graph=pocket2_graph)
