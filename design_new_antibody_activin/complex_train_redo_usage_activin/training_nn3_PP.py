...
np.random.seed(0)
torch.manual_seed(0)
print (dataset.__len__(),"xxxxxxxxxxxxx")

train_dataset, val_dataset = random_split(dataset, (30000,4835))
...
for name in range(2,13):
    print (name)
    train_data = TestbedDataset2(root='data1', dataset='L_P_train_'+str(name))
    dataset_pos=dataset_pos + train_data


print (dataset_pos.__len__(),"xxxxxxxxxxxxx")
train_dataset_pos, val_dataset_pos = random_split(dataset_pos, (5000,895))
...
dataset_train_all=train_dataset_pos_n+train_dataset
dataset_test_all=val_dataset_pos_n + val_dataset
