...
np.random.seed(0)
torch.manual_seed(0)
train_dataset, val_dataset = random_split(dataset, (45000, 7200))
...
for name in range(2,175):
    print (name)
    train_data = TestbedDataset2(root='data1', dataset='L_P_train_'+str(name))
    dataset_pos=dataset_pos + train_data
train_dataset_pos, val_dataset_pos = random_split(dataset_pos, (15000,2400))

train_dataset_pos=train_dataset_pos+train_dataset_pos+train_dataset_pos

dataset_train_all=train_dataset_pos+train_dataset
dataset_test_all=val_dataset_pos + val_dataset
...
for datasetxxxx in 'L':
        ...
        model = torch.load('full_model_out900.model')
